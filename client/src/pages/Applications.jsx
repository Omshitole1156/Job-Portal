...
const Applications = () => {
  const { user} = useUser(); // Ensure user is defined before using
  ...
  // Handle case where user is not found (shouldn't happen if signed in)
          ...
          {isEdit || (userData && userData.resume === "") ? (
            ...
            <div className="flex gap-2">
              <a
                ...
                target = '_blank' href={userData.resume}
              >
                Resume
              </a>
              <button
